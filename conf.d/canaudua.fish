...
function canaudua_initial -e fish_prompt
  canaudua_setup &
...
function canaudua_refresh -v canaudua_left_prompt_$fish_pid -v canaudua_right_prompt_$fish_pid
  commandline -f repaint
end

function canaudua_exit -e fish_exit
