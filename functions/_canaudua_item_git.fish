function _canaudua_item_git
  ...
  test $conflicted -ne 0; and printf ' %s %s' $canaudua_git_icon_conflicted $conflicted
  test $staged -ne 0; and printf ' %s %s' $canaudua_git_icon_staged $staged
  test $dirty -ne 0; and printf ' %s %s' $canaudua_git_icon_dirty $dirty
  test $untracked -ne 0; and printf ' %s %s' $canaudua_git_icon_untracked $untracked
  test $stashed -ne 0; and printf ' %s %s' $canaudua_git_icon_stashed $stashed
  test $upstream_behind -ne 0; and printf ' %s %s' $canaudua_git_icon_behind $upstream_behind
  test $upstream_ahead -ne 0; and printf ' %s %s' $canaudua_git_icon_ahead $upstream_ahead
end
